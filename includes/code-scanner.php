...
class Code_Scanner {
    ...
    public function __construct() {
        ...
        $this->plugins_root_dir = WP_PLUGIN_DIR;
        $this->themes_root_dir = get_theme_root(__DIR__);
        ...
        // Settings link
        add_filter("plugin_action_links_" . plugin_basename(CS_MS_PATH . 'code-scanner.php'), array($this, 'add_settings_link'));
    ...
    public function enqueue_admin_styles() {
        ...
        if ($this->plugin_screen_hook_suffix == $screen->id) {
            wp_enqueue_style($this->plugin_slug . '-admin-styles', CS_MS_CSS_URL . 'admin.css', array(), self::VERSION);
            wp_enqueue_style($this->plugin_slug . '-fontawesome', CS_MS_CSS_URL . 'font-awesome.min.css', array(), self::VERSION);
        }
    }
    ...
    public function enqueue_admin_scripts() {
        ...
        $screen = get_current_screen();
        if ($this->plugin_screen_hook_suffix == $screen->id) {
            wp_enqueue_script($this->plugin_slug . '-admin-script', CS_MS_JS_URL . 'admin.js', array(), self::VERSION);
        }
    }
    ...
    public function load_admin_page() {
        include_once(CS_MS_VIEWS_PATH . 'admin.php');
    }
